...
public class GroundWaterFactory extends AbstractFactory{
    /**
     * Constructs a GroundWaterFactory object with the specified DataPanel.
     * @param dataPanel the DataPanel to be associated with the factory
     */
    public GroundWaterFactory(DataPanel dataPanel) {
        super(dataPanel);
    }
    /**
                ...
                public void actionPerformed(ActionEvent e) {
                    if(e.getSource() == data.getAddButton()){
                        if (model.getText().length() < 2){
                            ...
                            ColorDecorator v = new ColorDecorator(new StatusDecorator(new Amphibious(model.getText(), parseInt(passNum.getText().toString()),
                            ...
                            a.addVehicle(v,"added","Amphibious");
                        }
                    }
                }
            });
